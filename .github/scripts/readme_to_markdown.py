...
badges ([![alt](img)](link)) and relative image paths are rewritten to
absolute raw GitHub URLs so they resolve off-site. The one exception is the
YouTube showcase, emitted as an <iframe> since CurseForge renders it as an
inline player.
...
RAW_BASE = "https://raw.githubusercontent.com/OgMzsty/Leaderstats/main"
